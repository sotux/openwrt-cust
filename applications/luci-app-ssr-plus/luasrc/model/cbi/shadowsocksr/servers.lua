...
uci:foreach("shadowsocksr", "servers",
            function(s) server_count = server_count + 1 end)
...
o.write = function()
    luci.http.redirect(luci.dispatcher.build_url("admin", "services",
...
function o.cfgvalue(...) return Value.cfgvalue(...) or "0" end
